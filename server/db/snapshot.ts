...
export const PARTS: Record<SnapshotPart, { collections: Collection[]; debounceMs: number }> = {
  core: {
    collections: ["profiles", "resumes", "resumeVersions", "applications", "notifications", "aiUsage", "audit", "conversations", "pendingActions", "settings", "userKeys", "agentUndo", "agentFeedback"],
    debounceMs: 15_000,
  },
